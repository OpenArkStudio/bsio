...
#define BSIO_PLATFORM_WINDOWS
#elif defined __APPLE_CC__ || defined __APPLE__
#define BSIO_PLATFORM_DARWIN
#else
#define BSIO_PLATFORM_LINUX
#endif

#ifdef BSIO_PLATFORM_LINUX
#include <endian.h>
#elif defined BSIO_PLATFORM_DARWIN
#include <sys/_endian.h>
#endif

namespace bsio::base::endian {
...
#elif defined BSIO_PLATFORM_LINUX
inline uint64_t hostToNetwork64(uint64_t host64, bool convert = true)
{
